...
/**
 * Navbar principal do portal.
 * - Links de navegação (React Router)
 * - Exibe nome do paciente autenticado
 * - Botão de logout (zera o contexto do paciente)
 */
const NAV_LINKS = [
...
export default function Navbar() {
  const { dadosPaciente, logout } = usePaciente()
  ...
  return (
    <header className="navbar">
      ...
      <div className="navbar-actions">
        ...
        <span className="navbar-user">{dadosPaciente.paciente?.nome}</span>
