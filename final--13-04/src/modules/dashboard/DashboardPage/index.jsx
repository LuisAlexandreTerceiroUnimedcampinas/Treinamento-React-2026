...
export default function DashboardPage() {
   ...
   * A maior parte do conteúdo é derivada de `exames` e `consultas` do contexto,
   * por isso usamos `useMemo` para calcular resumos sem recomputar à toa.
   */
  const { dadosPaciente } = usePaciente()
  const { paciente, exames, consultas } = dadosPaciente
  ...
  // Enquanto os dados não chegam (ou estão vazios), exibe um loading simples.
